    ...
    return (
        <div id='home' className='flex min-h-[350px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[720px] items-center'>
            <div className=' container mx-auto px-3'>
                ...
                <h1 className=' font-Outfit text-black font-light text-[33px] sm-text[40px] md:text-[50px] lg:text-[64px] max-w-[584px] leading-[40px] md:leading-[76px] '>Inspiring Innovation, Elevating Solutions – <span className=' font-semibold font-Montserrat'>Noble Mind"</span></h1>
