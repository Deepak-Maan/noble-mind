...
const Aboutus = () => {
    return (
        <div className='relative'>
            <div className=' absolute top-0 left-0 animate-pulse hidden sm:flex'><Ellipse /></div>
            <div className=' absolute bottom-[20%] right-[20px] hidden sm:flex'><Ellipse /></div>
            <div id='aboutus' className='container py-7 sm:py-10 md:py-20 lg:py-[150px]'>
                <div className="grid min-[1140px]:grid-cols-2 gap-1 sm:gap-7 md:gap-10 lg:gap-[75px]">
                    <div>
                        <Image className='mx-auto' src={AboutImg} alt={AboutImg} height={567} width={544} />
                    </div>
                    <div className=' pt-4'>
